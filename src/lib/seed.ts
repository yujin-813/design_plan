...
export const seed = {
  ...
  notices: [
    { id: 0, category: "운영 공지", pinned: true, title: "[AI 마케팅 3기] 알테라 오픈 안내 — 가입하고 승인받아 주세요", date: "09.17", by: "운영팀",
      body: "안녕하세요, K-디지털 뉴딜 아카데미 AI 마케팅 3기 여러분.\n수업 기간 동안 공지·자료·과제·일정을 한곳에서 관리할 커뮤니티 '알테라'를 엽니다.\n\n■ 가입 방법\n1. 로그인 화면에서 '수강생 가입'을 눌러주세요.\n2. 신청 과정에서 'AI 마케팅 3기'를 선택하고, 이름·이메일·비밀번호를 입력합니다.\n3. 신청하면 운영팀이 수강생 명단과 대조해 승인해드립니다.\n4. 승인 전까지는 '승인 대기' 화면만 보이고, 승인되면 과정 공지·자료·일정이 모두 열립니다.\n\n■ 꼭 지켜주세요\n- 이름은 수강 신청하신 실명 그대로 입력해주세요. 명단과 다르면 승인이 늦어집니다.\n- 이메일은 실제 사용하는 주소로 등록해주세요. 공지 발송에 쓰입니다.\n\n■ 개강 안내\n- 입교식 및 OT: 9월 21일(월) 11:00~18:00\n- 1주차는 9/21~9/23 진행되며, 9/24~9/27은 추석 연휴로 휴강입니다.\n- 전체 일정은 '내 수업 > 일정확인'에서 달력으로 확인하실 수 있어요.\n\n승인까지 보통 하루면 됩니다. 문제가 있으면 운영팀에 알려주세요. 개강일에 뵙겠습니다!" },
